...
<body>
    <a href="#" class="btn-flotante" id="btnCarrito">Productos en el carrito: <span class="badge bg-success" id="carrito"> 0 </span></a>
    ...
    <header>
        <div>
            <div>
                <h1>¡Descubra PHARMAVIDA!</h1>
                <p>Su destino para salud y bienestar. Productos de calidad, servicios especializados, y un equipo dedicado a su cuidado. ¡Bienvenido a una vida más saludable con nosotros!</p>
            </div>
        </div>
    </header>
